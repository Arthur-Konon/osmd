...
(1,'apartments','ID',NULL,NULL),
(2,'apartments','Active',NULL,NULL),
(3,'apartments','HouseID',NULL,NULL),
(4,'apartments','ApartNum',NULL,NULL),
(5,'apartments','SupervisorId',NULL,NULL),
(6,'apartments','TotalArea',NULL,NULL),
(7,'apartments','HeatedArea',NULL,NULL),
(8,'apartments','UsefulArea',NULL,NULL),
(9,'apartments','Privacy',NULL,NULL),
(10,'apartments','CellPhone',NULL,NULL),
(11,'apartments','RegTenantsQty',NULL,NULL),
(12,'apartments','ActTenantsQty',NULL,NULL),
(13,'apartments','ResidentialFund',NULL,NULL),
(14,'apartments','Remark',NULL,NULL),
(15,'apartments','LastUpdate',NULL,NULL),
